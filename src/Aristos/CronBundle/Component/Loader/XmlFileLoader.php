...
namespace Aristos\CronBundle\Component\Loader;
...
class XmlFileLoader extends FileLoader
{
    ...
    protected function parseNode(RouteCollection $collection, \DOMElement $node, $path, $file)
    {
        switch ($node->tagName) {
            case 'job':
                $this->parseJob($collection, $node, $path);
                break;
            case 'import':
    ...
    /**
     * Parses a job and adds it to the JobCollection.
     *
     ...
     */
    protected function parseJob(RouteCollection $collection, \DOMElement $definition, $file)
    {
        $defaults = array();
        $requirements = array();
        $options = array();
    ...
    {
        $location = __DIR__.'/schema/cronjob/cronjob-1.0.xsd';
